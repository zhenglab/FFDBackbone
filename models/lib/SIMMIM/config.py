...
def update_config(config, args):
    ...
    _update_config_from_file(config, 'models/lib/SIMMIM/simmim_finetune__vit_base__img224__800ep.yaml')
    config.defrost()
    if args.opts:
...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, default='models/lib/SIMMIM/simmim_finetune__vit_base__img224__800ep.yaml', metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('-c', help='222')
