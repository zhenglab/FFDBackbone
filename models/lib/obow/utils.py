...
#         # 将键中的 "_feature_blocks" 替换为 "layer"
#         new_key = key.replace("layer", "_feature_blocks.")
#         new_state_dict[new_key] = value


#     return network.load_state_dict(new_state_dict, strict=strict)